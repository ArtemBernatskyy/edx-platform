...
class OpaqueKeyReader(IdReader):
    ...
    def get_definition_id(self, usage_id):
        ...
        course_entry = split_modulestore._lookup_course(usage_id.course_key)
        return split_modulestore.create_runtime(self, course_entry, lazy=True).id_manager.get_definition_id(usage_key)
